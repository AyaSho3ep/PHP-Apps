...
if($_POST){
    $review->setProduct_id($_GET['id'])->setUser_id($_SESSION['user']->id)->setComment($_POST['comment'])->setRate($_POST['star']);
    if($review->newReview()){
       $successMessage ="<div class='alert alert-success text-center'>Rated Successfully</div>";
    }else{
       $errorMessage ="<div class='alert alert-danger text-center'>Something Went Wrong</div>"; 
            ...
            <div class="tab-content description-review-bottom">
                ...
                <div id="des-details3" class="tab-pane">
                    <div class="rattings-wrapper">
                        <!-- loop -->
                        <?php 
                       $reviewsResult =  $product->getReviews();

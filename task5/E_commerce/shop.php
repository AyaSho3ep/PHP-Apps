...
if($_GET){
    if(isset($_GET['subcategory'])){
        $subcategory->setId($_GET['subcategory']);

        if($subcategory->getSubcategory()->num_rows == 1){
            $product->setSubcategory_id($_GET['subcategory']);
            $products = $product->getProductsBySubcategory()->fetch_all(MYSQLI_ASSOC);
        }else{
        ...
        if($category->getCategory()->num_rows == 1){
            $product->setCategory_id($_GET['category']);
            $products = $product->getProductsByCategory()->fetch_all(MYSQLI_ASSOC);
        }else{
            header('location:errors/404.php');die;
        }
        ...
        if($brand->getBrand()->num_rows == 1){
            $product->setBrand_id($_GET['brand']);
            $products = $product->getProductsByBrand()->fetch_all(MYSQLI_ASSOC);
        }else{
            header('location:errors/404.php');die;
        }
    ...
    $products = $product->getProducts()->fetch_all(MYSQLI_ASSOC);
}
?>

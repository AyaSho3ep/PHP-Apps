...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    if(isset($_POST['change_password'])){
        ...
        $validation->setInput($_POST['old_password'] ?? "")->setInputName('old_password')->required()
        ->regex('/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,32}$/',"Minimum eight and maximum 32 characters, at least one uppercase letter, one lowercase letter, one number and one special character")->exists('users', 'password');
                                        ...
                                        <div class="billing-information-wrapper">
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                    <div class="billing-info">
                                                        ...
                                                        <?= $validation->getErrorMessage('old_password') ?>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-md-12">
                                                    <div class="billing-info">

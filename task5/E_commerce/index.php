...
$totalBrands = $brand->getBrands()->fetch_all(MYSQLI_ASSOC);
$newProducts =  $product->newProducts()->fetch_all(MYSQLI_ASSOC);
$orderedProducts =  $product->mostOrdered()->fetch_all(MYSQLI_ASSOC);
...
?>
    ...
    <div class="product-area bg-image-1 pt-100 pb-95">
        <div class="container">
            <div class="row">
                <?php foreach($totalBrands AS $brand) { ?>
                    <div class="col-3">
                ...
                <div class="col-4 ">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img alt="" src="assets/img/product/<?=$orderedProduct['image']?>">
                        </a>
                    ...
                    <div class="product-content text-left">
                        <div class="product-hover-style">
                            <div class="product-title">
                                <h4>
                                    <a href="product-details.html"><?= $orderedProduct['name_en'] ?></a>
                                </h4>
                            </div>
                            <div class="cart-hover">
                        ...
                        <div class="product-price-wrapper">
                            ...
                            <span class="product-price"><?= $orderedProduct['price'] ?> EGP </span>
                        </div>
                    </div>
                </div>
            <?PHP } ?>

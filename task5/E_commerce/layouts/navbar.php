...
$categoriesResult = $categoryModel->getCategories()->fetch_all(MYSQLI_ASSOC);
                                    ...
                                    <li class="mega-menu-position top-hover"><a href="shop.php">shop</a>
                                        <ul class="mega-menu">
                                           <?php foreach($categoriesResult AS $category){
                                            $subcategoryModel->setCategory_id($category['id']);
                                            $subcategoriesResult = $subcategoryModel->getSubcategoriesByCategory()->fetch_all(MYSQLI_ASSOC);
                                            ?>
                                            <li>
                                                <ul>
                                                    <li class="mega-menu-title "><a class="font-weight-bold" href="shop.php?category=<?= $category['id'] ?>"><?= $category['name_en'] ?></a></li>
                                                    <?php foreach($subcategoriesResult AS $subcategory){ ?>
